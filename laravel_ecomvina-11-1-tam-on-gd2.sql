...
-- Thời gian đã tạo: Th10 01, 2025 lúc 11:25 AM
...
(21, 8, 18, 69000, 76, 3, 76, 'Còn hàng', NULL),
...
(11, 10, 6, 1, 699000, 'Hiển thị'),
(20, 21, 2, 3, 138000, 'Hiển thị');
...
(2, 'admindemo', '$2y$12$PDbfT41cUl6VFlLjV9WdAup59mNIWuIuBP1LV2Gc1mm0xbR3Hjfo2', '0900000003', 'Nguyễn Admindemo', 'Nữ', '1995-05-12', 'vrc5EiyZweECd6mo17LVaZ47a8kKEeXOC6ucMx9G.jpg', 'admin', 'Hoạt động', NULL),
...
(6, 21, 1, '2', 'test cập nhật giỏ ', 'test cập nhật giỏ ', 'ss.png', 2, '2025-10-27', '2025-10-28', 'Hiển thị', NULL);
...
(12, 2, 'Dưỡng mi tế bào gốc C’Choi - Bio Placenta Lash Serum', 'duong-mi-te-bao-goc-cchoi-bio-placenta-lash-serum', 'DƯỠNG MI TẾ BÀO GỐC C’CHOI Bio-Placenta Lash Serum', 'Việt Nam', 'Việt Nam', 'Công khai', 30, 75, NULL),
...
(39, 5, 'Đơn hàng mới của bạn đang được xử lý', 'Cảm ơn bạn đã thanh toán đơn hàng. Đơn hàng của bạn hiện đang được chuẩn bị và sẽ sớm được giao đến địa chỉ bạn đã đăng ký.', '/taikhoan/donhang', 'Đã đọc'),
